class Visualizer {
    ...
    static drawLevel(ctx, level, left, top, width, height, outputLabels) {
        ...
        for (let i = 0; i < outputs.length; i++) {
            ...
            // draw line around the node for the biases
            ctx.beginPath();
            ctx.lineWidth = 2;
            ...
            if (outputLabels[i]) {
                ...
                ctx.fillText(outputLabels[i], x, top+nodeRadius*0.001);
                ctx.lineWidth = 0.5;
                ctx.strokeText(outputLabels[i], x, top+nodeRadius*0.001);
            }
        }
